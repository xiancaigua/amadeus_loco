...
from .amadeus_marl_env_cfg import AmadeusMarlEnvCfg


class AmadeusMarlEnv(DirectMARLEnv):
    cfg: AmadeusMarlEnvCfg

    def __init__(self, cfg: AmadeusMarlEnvCfg, render_mode: str | None = None, **kwargs):
