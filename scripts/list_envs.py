...
All the environments are registered in the `amadeus` extension. They start
...
import amadeus.tasks  # noqa: F401


def main():
    """Print all environments registered in `amadeus` extension."""
